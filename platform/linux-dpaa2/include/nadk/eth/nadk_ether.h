 ...
 */
#ifndef _NADK_ETHER_H_
#define _NADK_ETHER_H_
...
#define	NADK_ETHTYPE_IP		0x0800	/*!<IPv4 Protocol. */
#define	NADK_ETHTYPE_ARP	0x0806	/*!<Arp Protocol. */
#define	NADK_ETHTYPE_VLAN	0x8100	/*!<IEEE 802.1Q VLAN tagging. */
#define	NADK_ETHTYPE_VLAN_OUTER	0x88A8	/**<Stacked VLANs/QinQ,outer-tag/STAG*/
#define	NADK_ETHTYPE_IPV6	0x86DD	/*!<IPv6 Protocol. */
#define	NADK_ETHTYPE_FLOW_CTRL	0x8808	/**<Ethernet flow control */
#define	NADK_ETHTYPE_MACSEC	0x88E5	/**<MAC security IEEE 802.1AE */
#define	NADK_ETHTYPE_1588	0x88F7	/*!<802.1AS 1588 Precise Time Protocol*/
#define	NADK_ETHTYPE_REVARP	0x8035	/*!<Reverse addr resolution protocol*/
#define	NADK_ETHTYPE_PPP	0x880B	/*!<PPP (obsolete by PPPoE) */
#define	NADK_ETHTYPE_PPPOEDISC	0x8863	/*!<PPP Over Ethernet Discovery Stage*/
#define	NADK_ETHTYPE_PPPOE	0x8864	/*!<PPP Over Ethernet Session Stage */
#define	NADK_ETHTYPE_LOOPBACK	0x9000	/*!<Loopback: used to test interfaces*/
